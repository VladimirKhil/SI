...
namespace SIQuester
{
    ...
    public sealed class TextList : TextBox
    {
        ...
        // Using a DependencyProperty as the backing store for IsSynchronizedWithCurrentItem.  This enables animation, styling, binding, etc...
        ...
        {
            get { return (ILinkManager)GetValue(LinkManagerProperty); }
            set { SetValue(LinkManagerProperty, value); }
        }

        // Using a DependencyProperty as the backing store for LinkManager.  This enables animation, styling, binding, etc...
