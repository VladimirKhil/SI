...
namespace SIQuester.Utilities
{
    public sealed class PopupManager
    {
        ...
        public static bool? GetWasOpened(DependencyObject obj)
        {
            return (bool?)obj.GetValue(WasOpenedProperty);
        }

        public static void SetWasOpened(DependencyObject obj, bool? value)
        {
            obj.SetValue(WasOpenedProperty, value);
        }

        // Using a DependencyProperty as the backing store for WasOpened.  This enables animation, styling, binding, etc...
