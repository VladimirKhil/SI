...
/// <summary>
/// Defines interaction logic for RoundThemesView.xaml.
/// </summary>
public partial class RoundThemesView : UserControl
{
    private readonly Storyboard _biggerAnim;
    private readonly Storyboard _smallerAnim;
    ...
    private void BiggerAnim_Completed(object? sender, EventArgs e) => _smallerAnim.Begin(text);
    ...
    private void Animate() => _biggerAnim.Begin(text);
}
