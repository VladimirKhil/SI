...
namespace SIGame.Behaviors
{
    public static class Dragger
    {
        ...
        public static double GetDragPosition(DependencyObject obj)
        {
            return (double)obj.GetValue(DragPositionProperty);
        }

        public static void SetDragPosition(DependencyObject obj, double value)
        {
